...
📌ご注意📌  
このリポジトリは公開専用の簡易版です。yuasys組織内の方は[プライベートリポジトリ](https://github.com/yuasys/koyomi-today)を利用してください。
...
このアプリは無料で旧暦情報を提供されている[暦APIサイト様](https://koyomi.zingsystem.com/)のAPIを利用させていただいております。  
